...
void VK_ContextImpl::createInstance()
{
...
void VK_ContextImpl::setupDebugMessenger()
{
...
void VK_ContextImpl::createSurface()
{
...
void VK_ContextImpl::pickPhysicalDevice()
{
...
VK_Buffer *VK_ContextImpl::createBuffer(const std::vector<VK_Vertex> &vertices)
{
    auto vertexBuffer = new VK_VertexBuffer(this, device);
    vertexBuffer->create(vertices, this);
    return vertexBuffer;
}
